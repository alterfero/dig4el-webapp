...
const messages = {
  en: {
    ...
    findLanguageLabel: "Find a language",
    findLanguagePlaceholder: "Type a language name",
  ...
  fr: {
    ...
    findLanguageLabel: "Trouver une langue",
    findLanguagePlaceholder: "Saisir le nom d'une langue",
  ...
  es: {
    ...
    findLanguageLabel: "Buscar un idioma",
    findLanguagePlaceholder: "Escribe el nombre de un idioma",
  ...
  de: {
    ...
    findLanguageLabel: "Sprache finden",
    findLanguagePlaceholder: "Namen einer Sprache eingeben",
    noMatchingLanguages: "Keine passende Sprache gefunden",
  ...
  ru: {
    ...
    findLanguageLabel: "Найти язык",
    findLanguagePlaceholder: "Введите название языка",
  ...
  ja: {
    ...
    findLanguageLabel: "言語を探す",
    findLanguagePlaceholder: "言語名を入力",
